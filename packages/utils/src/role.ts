export type UserRole = "admin" | "operator" | "targetologist" | "client" | "advertiser" | "affiliate";
...
export const roleLabels: Record<UserRole, { uz: string; ru: string; en: string }> = {
  ...
  targetologist: { uz: "Targetolog", ru: "Таргетолог", en: "Targetologist" },
...
export const userRoleHierarchy: UserRole[] = ["admin", "operator", "targetologist", "client", "advertiser", "affiliate"];
