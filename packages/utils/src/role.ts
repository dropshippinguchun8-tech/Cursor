export type UserRole = "admin" | "operator" | "targetolog" | "client" | "advertiser" | "affiliate";
...
export const userRoleHierarchy: UserRole[] = ["admin", "operator", "targetolog", "client", "advertiser", "affiliate"];
